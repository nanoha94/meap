...
const featureShowcaseItems = [
    {
        title: '料理・レシピの登録と一覧',
        body: '材料や手順を登録し、自分だけのレシピ帳が作成できます。',
        bullets: [
            '料理名・材料名・カテゴリで絞り込み・検索',
            'タグやカテゴリで自由に分類・整理',
            '写真やURLからAIで読み込んで登録',
        ],
        screenshots: [
    ...
    {
        title: '献立表（カレンダー表示）',
        body: '登録済みの料理データを選んで献立を作成。月単位のカレンダーで俯瞰できます。',
        bullets: [
    ...
    },
    {
        ...
        body: '献立・レシピ・買い物リストなどをグループ内で共有できます。',
        bullets: [
            'QRコードやリンクでかんたんに招待',
            'グループ内で献立作成や買い物を分担',
            '全員のデータがリアルタイムに同期',
