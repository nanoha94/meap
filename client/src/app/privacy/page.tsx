...
import { LEGAL, LINK_TO } from '@/constants';
            ...
            <main className="flex justify-center px-4 py-12">
                <article className="w-full max-w-5xl ">
                    ...
                    <p className="mb-10 leading-relaxed">
                        屋号「{LEGAL.TRADE_NAME}」（以下「当事業者」といいます。）は、当事業者が提供するサービス「{LEGAL.SERVICE_NAME}」（以下「本サービス」といいます。）におけるお客様の個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
                    </p>
