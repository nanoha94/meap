...
| 3-6-16 | 【新規作成】 バリデーションエラー（mealTypeId 必須）                | 異常系 | mealTypeId パラメータが未入力          | HTTP 422 Validation Error                        | `MealPlanStoreRequest::rules()`  |
| 3-6-17 | 【新規作成】 バリデーションエラー（mealTypeId 形式）                | 異常系 | 無効な UUID 形式の mealTypeId を提供   | HTTP 422 Validation Error                        | `MealPlanStoreRequest::rules()`  |
| 3-6-18 | 【新規作成】 バリデーションエラー（mealTypeId 存在チェック）        | 異常系 | 存在しない mealTypeId を提供           | HTTP 404 Not Found                               | `MealPlanController::store()`    |
...
| 3-6-28 | 【新規作成】 バリデーションエラー（courseTypeId 必須）              | 異常系 | courseTypeId パラメータが未入力        | HTTP 422 Validation Error                        | `MealPlanStoreRequest::rules()`  |
| 3-6-29 | 【新規作成】 バリデーションエラー（courseTypeId 形式）              | 異常系 | 無効な UUID 形式の courseTypeId を提供 | HTTP 422 Validation Error                        | `MealPlanStoreRequest::rules()`  |
| 3-6-30 | 【新規作成】 バリデーションエラー（courseTypeId 存在チェック）      | 異常系 | 存在しない courseTypeId を提供         | HTTP 404 Not Found                               | `MealPlanController::store()`    |
...
| 3-6-47 | 【更新】 バリデーションエラー（mealTypeId 必須）                    | 異常系 | mealTypeId パラメータが未入力          | HTTP 422 Validation Error                        | `MealPlanUpdateRequest::rules()` |
| 3-6-48 | 【更新】 バリデーションエラー（mealTypeId 形式）                    | 異常系 | 無効な UUID 形式の mealTypeId を提供   | HTTP 422 Validation Error                        | `MealPlanUpdateRequest::rules()` |
| 3-6-49 | 【更新】 バリデーションエラー（mealTypeId 存在チェック）            | 異常系 | 存在しない mealTypeId を提供           | HTTP 404 Not Found                               | `MealPlanController::update()`   |
...
| 3-6-59 | 【更新】 バリデーションエラー（courseTypeId 必須）                  | 異常系 | courseTypeId パラメータが未入力        | HTTP 422 Validation Error                        | `MealPlanUpdateRequest::rules()` |
| 3-6-60 | 【更新】 バリデーションエラー（courseTypeId 形式）                  | 異常系 | 無効な UUID 形式の courseTypeId を提供 | HTTP 422 Validation Error                        | `MealPlanUpdateRequest::rules()` |
| 3-6-61 | 【更新】 バリデーションエラー（courseTypeId 存在チェック）          | 異常系 | 存在しない courseTypeId を提供         | HTTP 404 Not Found                               | `MealPlanController::update()`   |
