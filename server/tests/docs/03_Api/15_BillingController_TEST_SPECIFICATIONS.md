...
| 3-15-3 | 【課金状態取得】 メール未認証 | 異常系 | 認証済みユーザー（email_verified_at が null） | HTTP 409、メール未確認メッセージ | `BillingController::status()` |
...
| 3-15-8 | 【請求履歴取得】 メール未認証 | 異常系 | 認証済みユーザー（email_verified_at が null） | HTTP 409、メール未確認メッセージ | `BillingController::invoices()` |
...
| 3-15-13 | 【サブスク開始】 メール未認証 | 異常系 | 認証済みユーザー（email_verified_at が null） | HTTP 409、メール未確認メッセージ | `BillingController::subscribe()` |
...
| 3-15-20 | 【Customer Portal】 メール未認証 | 異常系 | 認証済みユーザー（email_verified_at が null） | HTTP 409、メール未確認メッセージ | `BillingController::portal()` |
...
| 3-15-26 | 【プラン変更予定取り消し】 メール未認証 | 異常系 | 認証済みユーザー（email_verified_at が null） | HTTP 409、メール未確認メッセージ | `BillingController::resume()` |
...
| 3-15-33 | 【パック購入】 メール未認証 | 異常系 | 認証済みユーザー（email_verified_at が null） | HTTP 409、メール未確認メッセージ | `BillingController::purchasePack()` |
