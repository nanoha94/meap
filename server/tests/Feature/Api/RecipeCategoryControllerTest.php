...
test('3-8-1: 【一覧取得】 正常な料理カテゴリ一覧取得', function () {
    // テスト用のカテゴリをAPIで作成
...
test('3-8-2: 【一覧取得】 レスポンス形式確認', function () {
    // テスト用のカテゴリをAPIで作成
...
test('3-8-3: 【一覧取得】 order 順での取得確認', function () {
...
test('3-8-4: 【一覧取得】 空のリスト取得', function () {
    // カテゴリが存在しない状態でテスト
    $response = $this->actingAs($this->user)->get('/recipe-categories');
...
test('3-8-5: 【一覧取得】 他グループの料理カテゴリは取得されない', function () {
    // 自グループのカテゴリを作成
    $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-6: 【一覧取得】 未認証ユーザー', function () {
...
test('3-8-7: 【一覧取得】 グループが存在しない', function () {
...
test('3-8-8: 【一覧取得】 データベース接続エラー', function () {
...
test('3-8-9: 【新規作成】 正常な料理カテゴリ作成', function () {
    $data = [
        'name' => '和食',
        'order' => 0
    ];
...
test('3-8-10: 【新規作成】 レスポンス形式確認', function () {
    $data = [
        'name' => '和食',
        'order' => 0
    ];
...
test('3-8-11: 【新規作成】 バリデーションエラー（料理カテゴリ名未入力）', function () {
    $data = [
        'order' => 0
    ];
...
test('3-8-12: 【新規作成】 バリデーションエラー（料理カテゴリ名が 255 文字超過）', function () {
    $data = [
...
test('3-8-13: 【新規作成】 バリデーションエラー（order 値が未入力）', function () {
    $data = [
        'name' => '和食'
    ];
...
test('3-8-14: 【新規作成】 バリデーションエラー（order 値が数値以外）', function () {
    $data = [
        'name' => '和食',
        'order' => 'abc'
    ];
...
test('3-8-15: 【新規作成】 バリデーションエラー（order 値が負の値）', function () {
    $data = [
        'name' => '和食',
        'order' => -1
    ];
...
test('3-8-16: 【新規作成】 未認証ユーザー', function () {
    $data = [
        'name' => '和食',
        'order' => 0
    ];
...
test('3-8-17: 【新規作成】 グループが存在しない', function () {
    $user = User::factory()->create([
        'email_verified_at' => now()
    ]);
    // グループに所属させない
...
test('3-8-18: 【新規作成】 データベース接続エラー', function () {
    DB::shouldReceive('connection')->andThrow(new \Exception('Database connection failed'));
...
test('3-8-19: 【新規作成】 料理カテゴリ作成失敗', function () {
...
test('3-8-20: 【一括更新】 正常な料理カテゴリ一括更新', function () {
    // テスト用のカテゴリをAPIで作成
    $response1 = $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-21: 【一括更新】 一括更新成功メッセージの確認', function () {
    // テスト用のカテゴリをAPIで作成
    $response1 = $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-22: 【一括更新】 一括更新後のデータ取得確認', function () {
    // テスト用のカテゴリをAPIで作成
    $response1 = $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-23: 【一括更新】 存在しない料理カテゴリの更新', function () {
    $data = [
        'data' => [
            [
...
test('3-8-24: 【一括更新】 他グループの料理カテゴリ更新', function () {
...
test('3-8-25: 【一括更新】 バリデーションエラー（data 未入力）', function () {
    $data = [];
...
test('3-8-26: 【一括更新】 バリデーションエラー（data が配列でない）', function () {
    $data = [
        'data' => 'not_array'
    ];
...
test('3-8-27: 【一括更新】 バリデーションエラー（data が空配列）', function () {
    $data = [
        'data' => []
    ];
...
test('3-8-28: 【一括更新】 バリデーションエラー（id が未入力）', function () {
    $data = [
        'data' => [
            [
                'name' => '和食',
...
test('3-8-29: 【一括更新】 バリデーションエラー（id が UUID 形式でない）', function () {
    $data = [
        'data' => [
            [
                'id' => 'invalid-uuid',
...
test('3-8-30: 【一括更新】 バリデーションエラー（name が未入力）', function () {
    $data = [
        'data' => [
            [
                'id' => '00000000-0000-0000-0000-000000000000',
...
test('3-8-31: 【一括更新】 バリデーションエラー（name が文字列でない）', function () {
    $data = [
        'data' => [
            [
                'id' => '00000000-0000-0000-0000-000000000000',
...
test('3-8-32: 【一括更新】 バリデーションエラー（order が未入力）', function () {
    $data = [
        'data' => [
            [
                'id' => '00000000-0000-0000-0000-000000000000',
...
test('3-8-33: 【一括更新】 バリデーションエラー（order が数値でない）', function () {
    $data = [
        'data' => [
            [
                'id' => '00000000-0000-0000-0000-000000000000',
...
test('3-8-34: 【一括更新】 バリデーションエラー（order が負の値）', function () {
    $data = [
        'data' => [
            [
                'id' => '00000000-0000-0000-0000-000000000000',
...
test('3-8-35: 【一括更新】 未認証ユーザー', function () {
    $data = [
        'data' => [
            [
                'id' => '00000000-0000-0000-0000-000000000000',
...
test('3-8-36: 【一括更新】 グループが存在しない', function () {
    $user = User::factory()->create([
        'email_verified_at' => now()
    ]);
    // グループに所属させない
...
test('3-8-37: 【一括更新】 データベース接続エラー', function () {
    DB::shouldReceive('connection')->andThrow(new \Exception('Database connection failed'));
...
test('3-8-38: 【一括更新】 料理カテゴリ更新失敗', function () {
...
test('3-8-39: 【一括削除】 正常な料理カテゴリ一括削除', function () {
    // テスト用のカテゴリをAPIで作成
    $response1 = $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-40: 【一括削除】 一括削除成功メッセージの確認', function () {
    // テスト用のカテゴリをAPIで作成
    $response1 = $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-41: 【一括削除】 削除後の order 整理確認', function () {
    // テスト用のカテゴリをAPIで作成
    $response1 = $this->actingAs($this->user)->post('/recipe-categories', [
        'name' => '和食',
        'order' => 0
...
test('3-8-42: 【一括削除】 存在しない料理カテゴリの削除', function () {
    $data = [
...
test('3-8-43: 【一括削除】 他グループの料理カテゴリ削除', function () {
    // 他グループのユーザーとカテゴリをAPIで作成
    $otherUser = User::factory()->create(['email_verified_at' => now()]);
    $otherGroup = Group::create(['group_size' => 1]);
    GroupUserMapping::create([
...
test('3-8-44: 【一括削除】 バリデーションエラー（IDs 未入力）', function () {
    $data = [];
...
test('3-8-45: 【一括削除】 バリデーションエラー（IDs が配列でない）', function () {
    $data = [
        'ids' => 'not_array'
    ];
...
test('3-8-46: 【一括削除】 バリデーションエラー（IDs が空配列）', function () {
    $data = [
        'ids' => []
    ];
...
test('3-8-47: 【一括削除】 バリデーションエラー（ID が UUID 形式でない）', function () {
    $data = [
        'ids' => ['invalid-uuid']
    ];
...
test('3-8-48: 【一括削除】 未認証ユーザー', function () {
    $data = [
        'ids' => ['00000000-0000-0000-0000-000000000000']
    ];
...
test('3-8-49: 【一括削除】 グループが存在しない', function () {
    $user = User::factory()->create([
        'email_verified_at' => now()
    ]);
    // グループに所属させない
...
test('3-8-50: 【一括削除】 データベース接続エラー', function () {
    DB::shouldReceive('connection')->andThrow(new \Exception('Database connection failed'));
...
test('3-8-51: 【一括削除】 料理カテゴリ削除失敗', function () {
