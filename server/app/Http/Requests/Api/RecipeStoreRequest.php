...
class RecipeStoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'thumbnailId.string' => __('validation.string', ['attribute' => __('validation.attributes.image_id')]),
            ...
            'steps.*.order.required' => __('validation.required', ['attribute' => __('validation.attributes.order')]),
