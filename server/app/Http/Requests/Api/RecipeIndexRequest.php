...
class RecipeIndexRequest extends BaseApiRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'recipe_name.max' => __('validation.max.string', ['attribute' => 'recipe_name', 'max' => ValidationLimits::STRING_MAX]),
            'ingredient_name.string' => __('validation.string', ['attribute' => 'ingredient_name']),
            'ingredient_name.max' => __('validation.max.string', ['attribute' => 'ingredient_name', 'max' => ValidationLimits::STRING_MAX]),
