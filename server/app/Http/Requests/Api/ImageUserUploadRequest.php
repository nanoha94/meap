...
class ImageUserUploadRequest extends BaseRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'image.mimes' => __('validation.mimes', ['attribute' => 'image', 'values' => 'jpeg,png,gif,webp']),
    ...
    {
        return __('operations.image.upload');
    }
}
